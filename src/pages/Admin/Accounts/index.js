...
const TABLE_HEAD = ['Mã tài khoản', 'Họ và tên', 'Loại tài khoản', ''];
            ...
            <form>
               <Card className="block h-full w-full ">
                  <div className="border-b m-4 p-4 border-gray-900/10 pb-12">
                     <h2 className="text-base font-semibold leading-7 text-gray-900">Thêm tài khoản mới</h2>
                  ...
                  <div className="mb-8 flex items-center justify-between gap-8">
                     ...
                     <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
                        <Button className="flex items-center gap-3" color="blue" size="sm" onClick={handleOpenForm}>
                           <PlusIcon strokeWidth={2} className="h-4 w-4" /> Thêm tài khoản
                        </Button>
                     </div>
                  </div>

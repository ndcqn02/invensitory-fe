         ...
         {isOpen ? (
            ...
            <Card className="block   h-full w-1/2">
               <div className="border-b m-4 p-4 border-gray-900/10 pb-12">
                  <h2 className="text-base font-semibold leading-7 text-gray-900">Tạo mới phiếu trả </h2>
                           ...
                           <tr key={name}>
                              ...
                              <td className={classes}>
                                 <Tooltip content="Xem chi tiết phiêu nhập">
                                    <Link to="/staff/return-order-detail">
